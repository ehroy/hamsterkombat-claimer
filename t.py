        ...
        if access_token:
            ...
            if config["game_play"]:
             await play_game(access_token, "2056")
                ...
                print(f"Game play is disabled. \nSet game_play to True in config.py to enable game play which have currently not finish coding yet!")
            print(f"Sleeping for {random_sleep} minutes...")
