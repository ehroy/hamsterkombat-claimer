...
def get_new_token(query_id):
    ...
    data = json.dumps({"query": query_id,'referralToken': 'pGLl26U7Hg'})
    ...
    while True:
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                counter += 1
                print(response.json())
                print(f"\r{Fore.RED+Style.BRIGHT}Gagal mendapatkan token, percobaan {counter + 1}", flush=True)
                if counter >= 10:  # Check if the counter has reached 10
                    return None
                    break
                time.sleep(1)
                    ...
                    while True:
                        try:
                            ...
                            if("eyJhbGci" in token):
                                ...
                                print(f"{Fore.BLUE+Style.BRIGHT}\r\n====[{Fore.WHITE+Style.BRIGHT} Mencoba Mendapat Data Account {Fore.BLUE+Style.BRIGHT}]====")  
